 ...
 * HW Week 7 Problem 1
 * Description: Implement MyLinkedList
 * Input: a name and an index
 * Output: different functions of linkedlist put to use
 ...
 * -1
 * -1
 * [Tom, Oscar, Kim, George, Peter, Jean, George, Jane, Denise, Jenny, Kathy, Jane]
 */
...
public class Exercise24_02HW {
	...
	public class MyLinkedList<E> implements MyList<E> {
		...
		public boolean contains(Object o) { // implemented
			Node<E> current = head;
			while (current != null) {
		...
		@Override /**
					 ...
					 * no match.
					 */
		public int indexOf(Object o) { // implemented
			Node<E> current = head;
			for (int i = 0; i < size; i++) {
				if (current.element.equals(o)) {
					return i;
		...
		@Override /**
					 ...
					 * match.
					 */
		public int lastIndexOf(Object o) { // implemented
			int update = -1;
			Node<E> current = head;
			for (int i = 0; i < size; i++) {
				if (current.element.equals(o)) {
