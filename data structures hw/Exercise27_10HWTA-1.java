 ...
 * Description: Write a program that generates random double values to store in myhashset and myarraylist,
 * then generate a list of random double values. For each number in the list, check if it is in the hashset or arraylist,
 * display the total test time for each.
 * Input: n/a
 * Output: The time difference myhashset and myarraylist take to check if they contain numbers from list1
...
public class Exercise27_10HWTA {
	public static void main(String[] args) {
		...
		System.out.println("MyHashSet takes " + (endTime-startTime) + " milliseconds to check.");
		
		
		
		long startTime2 = System.currentTimeMillis();
		for (double num2 : list1) {
			list.contains(num2);
		}
		long endTime2 = System.currentTimeMillis();
		System.out.println("MyArrayList takes " + (endTime2-startTime2) + " milliseconds to check.");
	}
 ...
 * 
 * (For 1000 doubles)
 * MyHashSet takes 7 milliseconds to check.
 * MyArrayList takes 12925 milliseconds to check.
 * 
 * (For 10,000 doubles)
 * MyHashSet takes 7 milliseconds to check.
 * MyArrayList takes 13091 milliseconds to check.
 * 
 * (For 100000 doubles)
 * MyHashSet takes 9 milliseconds to check.
 * MyArrayList takes 12945 milliseconds to check. 
 */
